"""
Django settings for divine_limit_45286 project.
...
ROOT_URLCONF = 'divine_limit_45286.urls'
...
WSGI_APPLICATION = 'divine_limit_45286.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "divine_limit_45286 API",
    "DESCRIPTION": "API documentation for divine_limit_45286 App",
    "VERSION": "v1",
}
